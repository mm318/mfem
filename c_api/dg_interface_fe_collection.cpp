...
CMFEM_ASSERT_TYPE(CMFEM_DG_Interface_FECollection, mfem::DG_Interface_FECollection);

} // namespace

extern "C" {

CMFEM_DG_Interface_FECollection *CMFEM_DG_Interface_FECollection_NewOrderDim(int order,
                                                                             int dim)
{

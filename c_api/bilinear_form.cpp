...
void CMFEM_BilinearForm_EnableSparseMatrixSorting(CMFEM_BilinearForm *bilinear_form,
                                                  int enable)
{
   cmfem::As<mfem::BilinearForm>(bilinear_form)->EnableSparseMatrixSorting(enable != 0);
}
...
void CMFEM_BilinearForm_RecoverFEMSolution(const CMFEM_BilinearForm *bilinear_form,

...
int main(int argc, char *argv[])
{
   ...
   if (!mesh_file)
   {
      ...
      {
         case beam:
            mesh_file = mfem::test::ExamplesDataPath("beam-hex.mesh");
            break;
         case disc:
            mesh_file = mfem::test::ExamplesDataPath("square-disc.mesh");
            break;
         case lshape:
            mesh_file = mfem::test::ExamplesDataPath("l-shape.mesh");
            break;
         case fichera:
            mesh_file = mfem::test::ExamplesDataPath("fichera.mesh");
            break;
         default:
            exact_known = false;
            mesh_file = mfem::test::ExamplesDataPath("inline-quad.mesh");
            break;
      }
   }
